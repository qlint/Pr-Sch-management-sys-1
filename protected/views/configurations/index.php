                ...
                <div class="setbx_bot">
                    <ul>
                       ...
                       <li class="menu_box">
                        ...
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-key"></i></div>
                        <?php echo CHtml::link(Yii::t('app','Authentication').'<span>'.Yii::t('app','Manage Authenitication').'</span>', array('/configurations/authentication'),array('class'=>'name-txt')) ?></li>
                        <?php 
						}
						?>
                    ...
                    <?php echo CHtml::link(Yii::t('app','Manage Terms').'<span>'.Yii::t('app','Create and Manage Terms').'</span>', array('terms/index',),array('id'=>'set_grade_level','class'=>'name-txt')) ?></li>
            ...
            <div class="setbx_bot">
                <ul>
                   ...
                   <li class="menu_box">
                    ...
                    <li class="menu_box">
                    <div class="set_icon"><i class="fa fa-calendar"></i></div>
                    <?php echo CHtml::link(Yii::t('app','Default Weekdays').'<span>'.Yii::t('app','Default School Weekdays').'</span>', array('weekdays'),array('class'=>'name-txt')) ?></li>
                    <?php
					}
					if(ModuleAccess::model()->check('Settings'))
					{
                    ...
                    <?php echo CHtml::link(Yii::t('app','Set Default Grading Levels').'<span>'.Yii::t('app','Setting the Default Grading Levels').'</span>', array('examination/gradingLevels/list','key'=>'NULL'),array('id'=>'set_grade_level','class'=>'name-txt')) ?></li>
                    <?php
					}
					?>
                    <li class="menu_box">
                    <div class="set_icon"><i class="fa fa-mortar-board"></i></div>
                    <?php echo CHtml::link(Yii::t('app','Manage Exam Format').'<span>'.Yii::t('app','Choose Exam Format').'</span>', array('/configurations/examformat',),array('id'=>'set_grade_level','class'=>'name-txt')) ?></li>
                    
                    <li class="menu_box">
                    <div class="set_icon"><i class="fa fa-tasks"></i></div>
                    <?php echo CHtml::link(Yii::t('app','Manage Timetable Format').'<span>'.Yii::t('app','Choose Timetable Format').'</span>', array('/configurations/timetableformat',),array('class'=>'name-txt')) ?></li>
                ...
                <div class="setbx_bot">
                    <ul>            
                        <li  class="menu_box">
                        	...
                        	<?php
                            	echo CHtml::ajaxLink(
									Yii::t('app', 'Attendance Settings').'<span>'.Yii::t('app','Manage Attendance Type').'</span>',
									Yii::app()->createUrl('configurations/attendanceSettings' ),
									array(
										'type' => 'GET',
										'dataType' => 'text',
										'update' => '#help_link',
                ...
                <div class="setbx_bot">
                    <ul>
                        <li class="menu_box">
                            ...
                            <?php echo CHtml::link(Yii::t('app','SMS Gateway').'<span>'.Yii::t('app','SMS Gateway Settings').'</span>', array('sms/gateway'),array('class'=>'name-txt')) ?>
                        </li>
                        <?php /*?><li>
	...
	?>     
      ...
      <div class="clear"></div>
       <div class="block_box">
            <div class="setbx" style="width:700px;">
                <div class="setbx_top">
                <h1 class="headings"><?php echo Yii::t('app','Mobile Notifications');  ?></h1>
                </div>
                <div class="setbx_bot">
                    <ul>
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-bell" aria-hidden="true"></i></div>
                        <?php echo CHtml::link(Yii::t('app','Push Notification').'<span>'.Yii::t('app','Manage Mobile Push Notification').'</span>', array('/mobileNotification'),array('class'=>'name-txt')) ?></li>                        
                    </ul>
                </div>
                <div class="clear"></div>
                </div>
