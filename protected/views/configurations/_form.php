    ...
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
                ...
                <td width="33%">
                	<?php echo "<label>".Yii::t('app','Registration ID')."</label>";?> 
					<?php 
            	...
            	<td width="33%">
                	<?php echo "<label>".Yii::t('app','Founded On')."</label>";?>
					<?php 
            ...
            <tr>
            	<td colspan="3" class="td_1">
                	<?php echo "<label>".Yii::t('app','Address')."</label>";?>
					<?php 
                    $val_5 = $model->findByPk(2);
                    echo CHtml::textArea('address',$val_5->config_value,array('style'=>'width:100% !important; height: 150px;')); 
                    ?>
				</td>
                </tr>
                    <tr>
                        <td>
                        <?php echo "<label>".Yii::t('app','Curriculum')."</label>";?>
                        <?php 
                        ...
                        <td>
                    <?php echo "<label>".Yii::t('app','Zip code')."</label>";?>
                    <?php 
                    ...
                    ?>
                        ...
                        <td>
                            <?php echo "<label>".Yii::t('app','Phone')."</label>";?>
                            <?php 
            ...
            <tr>
                <td>
                	<?php echo "<label>".Yii::t('app','Alternate Phone')."</label>";?> 
					<?php 
            	...
            	<td>
                	<?php echo "<label>".Yii::t('app','Email')."</label>";?>
					<?php 
                ...
                <td>
                	<?php echo "<label>".Yii::t('app','Fax')."</label>";?>
					<?php 
            ...
            <tr>
                <td  class="td_1">
                <?php echo "<label>".Yii::t('app','Upload Logo')."</label>";?>
                    ...
                    ?> 
                         <p><strong><i><?php echo Yii::t('app','(supported formats : .jpg , .png ; max filesize: 60Kb,');?><?php echo Yii::t('app','recommended size : 64*64');?>)</i></strong></p>
                    </div>
            ...
            <tr>
                 <td  class="td_1">
                    <?php echo "<label>".Yii::t('app','Favicon')."</label>"; ?>
                    <div class="formCon_os_infpbox">
                    <?php
			...
			echo '<img src="'.Yii::app()->request->baseUrl.'/uploadedfiles/school_favicon/'.$fav->icon.'" alt="" border="0" height="55" />';	 	
				...
				if($i==0)
                    ...
                    ?> 
                        <p><strong><i><?php echo Yii::t('app','(supported formats : .ico, .jpg');?>
                    <?php echo Yii::t('app','recommended size : 16*16');?>)</i></strong></p>
                    </div>
...
<div class="formCon_os">
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
                <td>
                    <?php echo "<label>".Yii::t('app','Name of the Principal')."</label>";?>
                    <?php 
                ...
                <td>
                    <?php echo "<label>".Yii::t('app','Email of the Principal')."</label>";?>
                    <?php 
            ...
            <tr>
                ...
                <td>
                    <?php echo "<label>".Yii::t('app','Mobile')."</label>";?>
                    <?php 
    ...
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	...
        	<tr>
            	<td class="td_1">
					<?php
                    echo CHtml::link('<b>'.Yii::t('app','Create New Academic Year').'</b>', array('/AcademicYears/create'), array('class'=>'a_tag-btn'));
                    ?>
                 </td>
           </tr>           
<tr>
<td>
<?php echo "<label>".Yii::t('app','Academic Year <span class="required">*</span>')."</label>";?>
<?php
...
?> 
 ...
 <td><?php echo "<label>".Yii::t('app','Finance Year Start')."</label>";?>
					<?php 
                ...
                <td>
				<?php echo "<label>".Yii::t('app','Finance Year End')."</label>";?>
                    <?php 
            ...
            <tr>
            	<td class="td_1">
                <?php
				echo CHtml::link('<div class="green_box_notice">'.Yii::t('app','School Academic Year is not set. Save school settings and click here to setup a new academic year.').'</div>', array('/academicYears/create'));
				?>
                </td>
<td><?php echo "<label>".Yii::t('app','Finance Year Start')."</label>";?>
					<?php 
...
<div class="formCon_os">
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        		<tr>
                    <td>
                    <?php echo "<label>".Yii::t('app','Currency');?>
                    <?php 
                    ...
                    <td>
                    <?php echo "<label>".Yii::t('app','Language')."</label>";?>
                    <?php 
                    ...
                    <td>
                <?php echo "<label>".Yii::t('app','Date Format')."</label>";?>
                ...
                <tr>
                <td>
				<?php echo "<label>".Yii::t('app','Time Zone')."</label>";?>
					<?php 
                    if($usersettings!=NULL)
                    {
...
<div class="yellow_box_notice">
    <?php echo Yii::t('app','Note : Admission number cannot be changed once admissions have started'); ?>
</div>
<div class="formCon_os">
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
            	<td>
                    <?php echo "<label>".Yii::t('app','Admission Number Start <span class="required">*</span>')."</label>";?>
                    <?php
						$is_onlineadmission_start = StudentsUser::model()->findByAttributes(array('is_online'=>1));											
