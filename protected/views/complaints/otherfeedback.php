<?php
 $this->breadcrumbs=array(
	 Yii::t('app','Complaint List')=>array('/complaints/feedbacklist'),
	 Yii::t('app', 'View')
);
?>
                                                                    ...
                                                                    <div class="bottom-cht-hr">
                                                                        ...
                                                                        <?php 
																			if($complaint->status == 0){
																				...
																				echo CHtml::link('<i class="fa fa-trash-o"></i>',"#",array('submit'=>array('delete','id'=>$feedback->id),'title'=>'delete','class'=>'pull-right','style'=>'margin-right:7px','confirm'=>Yii::t('app','Are you sure you want to delete this comment ?'), 'csrf'=>true));
																			}
																		?>                                                                        
