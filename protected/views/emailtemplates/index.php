        ...
        <div class="cont_right formWrapper">
        	<table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody><tr>
                    ...
                    <h1><?php echo Yii::t('app','Email Templates');?></h1>
                    <div class="email-error"><p>*<?php echo Yii::t('app', 'Please do not remove the content within the');?> {{ }}</p></div>
                    <div style="position:relative;">
                    	...
                    	<div style="display:none;" class="sms-block" id="parent_body">
                        ...
                        <?php } ?>    
                            <div style="display:none;" class="sms-block" id="student_body">
                            <?php
                            foreach($templates as $template){
                            ...
                            <div style=" display:none" class="sms-block" id="employee_body">
                            <?php
                            foreach($templates as $template){
                        ...
                        <div class="tempCon" id="general_head">
                            ...
                            <div style=" display:none" class="sms-block" id="general_body">
                            <?php
                            foreach($templates as $template){
