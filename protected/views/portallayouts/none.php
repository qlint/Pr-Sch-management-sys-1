    ...
    <div class="headerbar" style="color: <?php echo $header_text_color; ?>; background-color: <?php echo $header_bar_background; ?>; border-left-color:<?php echo $header_border; ?> ">
      ...
      <a class="menutoggle" style="border-right-color: <?php echo $header_border; ?>"><i class="fa fa-bars"></i></a>
            ...
            <div class="searchform">
                <span class="col-md-4 profl_nme">
                <?php echo Yii::t('app','Welcome'); ?> <label class="name_bld"><?php echo $guard->parentFullName('forParentPortal');?></label> <?php echo Yii::t('app','in to your profile.'); ?>
                </span>
            </div>
        ...
        <!--<li>
          ...
          <?php /*?><li>
            <div class="btn-group">
              ...
              <?php echo CHtml::link(Yii::t('parentportal','<i class="glyphicon glyphicon-envelope"></i>'),array('/portalmailbox'),array('class'=>'btn btn-default dropdown-toggle tp-icon')); ?>
