...
<div class="edit_bttns " style="top:20px; right:14px;">   
        <ul>
       		<li>
            	<?php echo CHtml::link('<span>'.Yii::t('app','Clear Filter').'</span>', array('/documentUploads'),array('class'=>'addbttn last')); ?>
            </li>
        </ul>    
</div>
        ...
        <div class="filterbxcntnt_inner" style="border-bottom:#ddd solid 1px;">
            <ul>
                ...
                <li>
                    ...
                    <div id="identifier" style="display:none; width:250px; padding-top:0px; height:33px" class="drop" >
                        ...
                        <?php 
							...
							echo CHtml::activeDropDownList($model,'identifier',$identifier_list,array('prompt'=>Yii::t('app','All'))); ?>
                ...
                <li>
                    ...
                    <div id="status" style="display:none; width:250px; padding-top:0px; height:33px" class="drop" >
                        <div class="droparrow" style="left:10px;"></div>
                        <?php 
