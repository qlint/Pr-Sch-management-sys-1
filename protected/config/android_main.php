...
return array(
	...
	'preload'=>array('log','translate','background'),
   ...
   'rights'=>array(
	...
	'components'=>array(
		'background' => array(
			...
			'errorTimeout' => 500, // Nr of seconds after which ALL requests time out, measured from the last update.
			'userAgent' => 'Mozilla/5.0 Firefox/53.0', // Useragent used for the background request
			'backlogDays' => 30, // Number of days successfully completed request-entries are retained in the database
			'allBacklogDays' => 60, // Number of d
		),
		'osPdf'=> array(
