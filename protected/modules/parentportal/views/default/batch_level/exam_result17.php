...
$model= Students::model()->findByPk($_GET['sid']);
$student_id = $_GET['sid'];
$batch_id= $_GET['bid'];
			  ...
			  if($exams!=NULL)
		  	  {
					...
					{  
                      ...
                      ?>   
                      <div class="col-md-12">
					  	<?php  echo CHtml::link(Yii::t('app','Generate PDF'), array('/parentportal/default/cbsc17Pdf','exam_group_id'=>$examgroup->id,'id'=>$student_id, 'bid'=>$_REQUEST['bid']),array('class'=>'btn btn-danger pull-right','target'=>'_blank')); ?>
                       </div>
