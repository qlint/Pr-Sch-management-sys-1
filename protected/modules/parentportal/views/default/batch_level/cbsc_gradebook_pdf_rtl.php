            ...
            <tr>
                ...
                <td >
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="listbxtop_hdng-f1">
                                <h3>Gyan Sagar Educational & Charitable Society	</h3>
                                <p>(Sr. Sec. Recognised and Affiliated to CBSE)</p>
                            </td>
                        </tr>                                             
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="listbxtop_hdng-f2" width="100"><p><?php echo Yii::t('app','Address :'); ?></p></td>
                            <td class="listbxtop_hdng-f2"><p>P BLOCK, RAJ NAGAR-II, PALAM COLONY, NEW DELHI-110077</p></td>
                        </tr>
                        <tr>
                            <td class="listbxtop_hdng-f2" width="100"><p><?php echo Yii::t('app','Contact No :');?></p> </td>
                            <td class="listbxtop_hdng-f2"><p>011-25364480</p> </td>
                        </tr>
                        <tr>
                            <td class="listbxtop_hdng-f2" width="100"><p><?php echo Yii::t('app','Affiliation No :');?></p> </td>
                            <td class="listbxtop_hdng-f2"><p> 2730345</p> </td>
                        </tr>                                                 
                                                
                    </table>                    
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                             <td class="listbxtop_hdng-f2"> <p><span><?php echo Yii::t('app','Email Id :');?></span> gyansagarindia@rediffmail.com</p></td>
                            <td class="listbxtop_hdng-f2"> <p><span><?php echo Yii::t('app','Website :');?></span> www.gyansagarpublicschool.com</p></td>
                        </tr>                                                
...
<table cellspacing="0" cellpadding="0" border="0" width="100%"><tbody><tr><td height="10"></td></tr></tbody></table>
          ...
          <table class="report-hed" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tbody>
              <tr>
                <td><h2><?php echo Yii::t('app','Report Card')." - ".$year_name; ?></h2></td>
                </tr>
...
<div class="report-stu-dtls-table">
            ...
            <tbody>
                ...
                <td width="100"><?php echo Yii::t('app',"Father's Name"); ?></td>
                <td width="2">:</td>
              ...
              <tr>
                ...
                <td width="2">:</td>
                <td class="br-td"><?php echo $course->course_name;?></td>
                <td width="100"><?php echo Yii::t('app','Date Of Birth'); ?></td>
                <td width="2">:</td>
                <td><?php if(FormFields::model()->isVisible('date_of_birth','Students','forStudentProfile'))
								{
              ...
              <tr>
                <td width="100"><?php echo Yii::t('app',"Mother's Name"); ?></td>
                <td width="2">:</td>
                <td class="br-td"><?php echo Students::model()->getMotherName($model->id); ?></td>
                <td width="100"><?php echo Yii::t('app',"Admission No"); ?></td>
                <td width="2">:</td>
                <td> <?php if(FormFields::model()->isVisible('admission_no','Students','forStudentProfile'))
										   {
     ...
     <?php } ?>  
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%"><tbody><tr><td height="10"></td></tr></tbody></table>
 		<div class="report-table-cmn">
            ...
            <tbody>
                <tr>
                <th align="right"> <?php echo Yii::t('app','Attendance'); ?></th>
                <th width="180"><?php echo Yii::t('app','TERM I'); ?></th>
                <th width="180"><?php echo Yii::t('app','TERM II'); ?></th>
				</tr>
                
                <tr>
                <td align="right"><?php echo Yii::t('app','Total Working Session'); ?></td>
                ...
                <tr>
                <td align="right"><?php echo Yii::t('app','Total Attandance of the Student'); ?></td>
