              ...
              <table cellspacing="0" cellpadding="0" border="0" width="100%" class="inner-table">
                ...
                <?php if(isset($semester_enabled) and $semester_enabled==1){?> 
                 <?php if($sem_enabled==1 and $batch->semester_id!=NULL){ ?>
							...
							<td><?php   echo ucfirst($semester->name);?>
...
<table class="table-grade-box" width="100%" cellpadding="0" cellspacing="0" border="1">
    ...
    <tr>
        ...
        <th><?php echo Yii::t('app','Periodic Test');?>(10)</th>

        <th><?php echo Yii::t('app','Note Book');?>(5)</th>

        <th><?php echo Yii::t('app','Subject Enrichment');?>(5)</th>

        <th><?php echo Yii::t('app','Half Yearly Exam');?>(80)</th>

        <th><?php echo Yii::t('app','Mark Obtained');?>(100)</th>   
...
<table class="table-grade-box table-box-mrgn" width="100%" cellpadding="0" cellspacing="0" border="1">
	...
	<thead>
     ...
     <tr>   
        ...
        <th align="left" width="200">Discipline</th>

        <th width="535">Grade</th>
...
<table class="table-grade-box table-box-mrgn tablegrade-spc " width="100%" cellpadding="0" cellspacing="0" border="1">
    ...
    <tr>
        ...
        <h4>Grading scal for co-scholastic and Discipline CI.IX &#38; X </h4>

        <p>[On a 5 point(AC) Gradinf scale]
