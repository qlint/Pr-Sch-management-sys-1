         ...
         <ul class="nav nav-pills nav-stacked nav-bracket">
          ...
          <li>
           ...
           <li>
			   ...
			   $guardian 				= Guardians::model()->findByAttributes(array('uid'=>Yii::app()->user->id));  
                ...
                if(Yii::app()->controller->action->id == 'downloads')
                {
                    echo '<li class="active">';
					if($students){
						echo CHtml::link('<i class="fa fa-download"></i> <span>'.Yii::t('app','Downloads').'</span>',array('/parentportal/default/downloads', 'id'=>$students[0]->id));
					}
					else{
                    	echo CHtml::link('<i class="fa fa-download"></i> <span>'.Yii::t('app','Downloads').'</span>',array('/parentportal/default/downloads'));
					}
                    echo '</li>';
                }
                else
           ...
           <?php
			...
			{
				echo '<li class="active">';
				echo CHtml::link('<i class="fa fa-sign-in" aria-hidden="true"></i> <span>'.Yii::t('app','Log').'</span>',array('/parentportal/default/lognotice'));
				echo '</li>';
			}
			else
			{
				echo '<li>';
				echo CHtml::link('<i class="fa fa-sign-out" aria-hidden="true"></i> <span>'.Yii::t('app','Log').'</span>',array('/parentportal/default/lognotice'));
				echo '</li>';
			}
		   ?>
           </li>   
           	...
           	if(ModuleAccess::model()->check('Attendance'))
			{
				...
				{ 
					...
					if(Configurations::model()->studentAttendanceMode() == 2){ // for subjectwise attendance
						echo CHtml::link('<i class="fa fa-file-text"></i> <span>'.Yii::t('app','Attendance').'</span>',array('/parentportal/default/subwiseattendance', 'id'=>$students[0]->id));
					}
					else{
           ...
           <?php
			...
			{
			   	if(Yii::app()->controller->action->id=='cbsc17' or Yii::app()->controller->action->id=='exams' or Yii::app()->controller->action->id=='cbsc' or Yii::app()->controller->action->id=='examTimetable' or Yii::app()->controller->action->id=='semesters' or Yii::app()->controller->action->id=='exam' or Yii::app()->controller->action->id=='examList')
				{
					echo '<li class="active">';
