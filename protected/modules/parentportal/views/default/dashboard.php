	...
	<?php if($wards != NULL){ ?>
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="parent_studntDtls">
                    <ul>
                    	<?php 
							foreach($wards as $ward){
								$class	= '';
								if(isset($_REQUEST['id']) and $_REQUEST['id'] == $ward->id){
									$class	= 'active_stdn';
								}
						?>
                                <li>
                                    <?php echo CHtml::link($ward->studentFullName('forParentPortal'), array('dashboard','id'=>$ward->id), array('class'=>$class)); ?>
...
<div class="main_box">
    ...
    <?php } ?>
            ...
            <div class="table-responsive"  style=" height:455px ;overflow:hidden;">
		...
		foreach($events_sameday as $event_sameday)
		{
			...
			{	
				...
				$time=Configurations::model()->convertTime($event_sameday->start);
...
<div id="jobDialog"></div>
	   ...
	   <?php
		...
		$batch_arr	= array();
            ...
            <div class="people-item" style="height:420px; ">
                <div class="table-responsive">
            ...
            <div class="people-item" style="height:420px; overflow:hidden;">
            <div class="table-responsive">
			<?php 
  ...
  <?php if($student_batch_id and ($student_batch_id !=NULL or $student_batch_id!=0))
        { 
            ...
            else // default format
            {
                ...
                <div class="table-responsive scrollbox3">
                    <table class="table table-invoice">
                    <tr>
                      <th width="30%" height="35"><?php echo Yii::t('app','Exam');?></th>
                      <th  width="30%"  height="35"><?php echo Yii::t('app','Subject');?></th>
                      <th  width="30%"  ><?php echo Yii::t('app','Mark');?></th>
                    </tr>
                    ...
                    <?php foreach($examscores as $examscore)
                                    {
                                            ...
                                            if($sub->elective_group_id!=0 and $sub->elective_group_id!=NULL)
                                                            ...
                                                            { ?>
                                    <tr>
                                    <td width="30%"><?php echo $group->name ; ?></td>
                                    <td width="30%"><?php echo $subjectname ; ?></td>
                                    ...
                                    foreach($grades as $grade)
                                     ...
                                     foreach($grades as $grade)
                                        ...
                                        if($t<=0) 
                                            {
                                                echo $examscore->marks." & No Grades" ;
                                            }
                                         } 
                                    ?></td>
		 ...
		 <?php 
			...
			<table  border="0" cellspacing="0" cellpadding="0" class="table table-invoice">
			  ...
			  <tr>
				...
				?>
                	<td width="50%"><div class="dash_blue"><?php echo $ClassTiming->start_time.' - '.$ClassTiming->end_time ?></div></td>
                	<td width="50%" style="text-align:center;"><?php $subject = Subjects::model()->findByAttributes(array('id'=>$TimetableEntry->subject_id));
					  if($subject and $subject!=NULL)
					  {
						  echo $subject->name;
					  }
			...
			{
				echo Yii::t('app','You are not Enrolled in any1').' '.Yii::app()->getModule("students")->labelCourseBatch();
			}
			?>
    ...
    <?php } ?>
      ...
      <?php }} ?>
       ...
       <div class="col-sm-9 col-md-12 col-4-reqst">
                <div class="panel-heading">
