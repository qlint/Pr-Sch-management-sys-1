...
class Employees extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'home_pin_code' => Yii::t('app', 'Home ZIP Code'),
            ...
            'office_pin_code' => Yii::t('app', 'Office ZIP Code'),
    ...
    {
        if ($this->isNewRecord) {
            $student = StudentsUser::model()->findByAttributes(array('email' => $this->$attribute, 'is_deleted' => 0));
    ...
    public function number_check($attribute, $params)
    {
        if ((Yii::app()->controller->action->id != 'update' and Yii::app()->controller->id != 'default') and $this->$attribute != '' and Yii::app()->controller->action->id != 'update2') {
            ...
            if ($validate != null or $validate1 != null) {
                ...
                $this->addError($attribute, Yii::t('app', 'Mobile number already in use'));
            }
        }
    }
