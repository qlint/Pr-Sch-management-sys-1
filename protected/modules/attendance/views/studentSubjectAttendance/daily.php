...
$criteria->params		= array(":batch_id"=>$batch->id, ':status'=>1, ':result_status'=>0);
                                                    ...
                                                    <h3><?php echo Yii::t('app','Subject Wise Attendance'); ?></h3>
															...
															<div class="opnsl_headerBox">
                                                                <div class="opnsl_actn_box">
                                                                  <div class="opnsl_actn_box_1">
<div class="atnd_table-calender-bg atnd_tnav-new box-one-lft-rght" align="center">
                                                                    <?php
																		echo CHtml::link('<div class="atnd-table-arow-left"><img src="'.Yii::app()->request->baseUrl.'/images/attnd-arow-left.png" height="13" width="7" border="0"></div>', array('/attendance/studentSubjectAttendance/daily', 'id'=>$batch->id, 'date'=>$prev_day), array('title'=>Yii::t('app', 'Previous Day')));											
																		...
																		if($next_day<=date('Y-m-d')){
																			echo CHtml::link('<div class="atnd_arow_r"><img src="'.Yii::app()->request->baseUrl.'/images/attnd-arow-right.png" height="13" width="7" border="0"></div>', array('/attendance/studentSubjectAttendance/daily', 'id'=>$batch->id, 'date'=>$next_day), array('title'=>Yii::t('app', 'Next Day')));										
																		}
										?>                          
                                                                </div>
                                                                	</div>
...
<div class="subwise-blk box-one-lft-rght">
                                                                	<ul>
                                                                        <li> <?php echo CHtml::link(Yii::t("app","Daily"), array("/attendance/studentSubjectAttendance/daily", "id"=>$bid), array("class"=>"sub-attnd-daily active-attnd"));?> </li>
                                                                   
                                                                        <li><?php echo CHtml::link(Yii::t("app","Weekly"), array("/attendance/studentSubjectAttendance/index", "id"=>$bid), array("class"=>"sub-attnd-weekly"));?></li>
                                                                    </ul>
                                                                </div>
                                                                	</div>                                                                
                                                                </div>
												...
												if($students!=NULL){
                                                    if($timings!=NULL){
													 ?>
                                                      <div class="attnd-tab-inner-blk-new">
														<div class="pdf-box">
                                                            <div class="box-two">
                                                            	<?php 
																...
																echo CHtml::link(Yii::t("app",'Generate PDF'), array('/attendance/studentSubjectAttendance/dailyPdf','batch'=>$batch->id, 'date'=>$date),array('target'=>'_blank','class'=>'pdf_but')); 
																}?>
                                                            </div>
                                                  		</div>
													<?php
