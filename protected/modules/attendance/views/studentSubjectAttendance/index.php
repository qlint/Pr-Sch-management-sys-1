                                   ...
                                   <div class="subwis-tableposctn">
                                    <div class="formWrapper formWrapper-subwis">
                                        <div  style="width:100%">                            
                                                ...
                                                if(isset($_REQUEST['id']) and $_REQUEST['id']!=NULL){
                                                        ...
                                                        <div class="tab-sectn">
                                                            <ul>
                                                             <?php if(Configurations::model()->studentAttendanceMode() != 2){ ?>
                                                                		<li><?php echo CHtml::link(Yii::t("app","DAY WISE"), array("/attendance/studentAttentance", "id"=>$bid), array("class"=>"sub-attnd-daily"));?> </li>
                                                            <?php } ?>    
                                                            <?php if(Configurations::model()->studentAttendanceMode() != 1){ ?>
                                                                <li><?php echo CHtml::link(Yii::t("app","SUBJECT WISE"), array("/attendance/studentSubjectAttendance/daily", "id"=>$bid), array("class"=>"sub-attnd-daily active-attnd"));?>  </li>
                                                            <?php } ?>        
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="attnd-tab-inner-blk">
                                                        ...
                                                        <div class="atnd_table-calender-bg atnd_tnav-new box-one-lft-rght" align="center">
                                                                    <?php
																		echo CHtml::link('<div class="atnd-table-arow-left"><img src="'.Yii::app()->request->baseUrl.'/images/attnd-arow-left.png" height="13" width="7" border="0"></div>', array('/attendance/studentSubjectAttendance/index', 'id'=>$batch->id, 'stud_id'=>$stud_id, 'date'=>$prev_week_start), array('title'=>Yii::t('app', 'Previous Week')));											
																		?>
                                                               <div class="fixed-datepik">
                                                                      ...
                                                                      <input type="hidden" id="day" class="week-picker" value="<?php echo $date;?>"/>
																		...
																		<?php
																		echo CHtml::link('<div class="atnd_arow_r"><img src="'.Yii::app()->request->baseUrl.'/images/attnd-arow-right.png" height="13" width="7" border="0"></div>', array('/attendance/studentSubjectAttendance/index', 'id'=>$batch->id, 'stud_id'=>$stud_id, 'date'=>$next_week_start), array('title'=>Yii::t('app', 'Next Week')));										
																		?>                          
                                                                </div>
                                                                <div class="subwise-blk box-one-lft-rght">
                                                                    <ul>
                                                                        <li>  <?php echo CHtml::link(Yii::t("app","Daily"), array("/attendance/studentSubjectAttendance/daily", "id"=>$bid), array("class"=>"sub-attnd-daily"));?>  </li>
                                                                        <li><?php echo CHtml::link(Yii::t("app","Weekly"), array("/attendance/studentSubjectAttendance/index", "id"=>$bid), array("class"=>"sub-attnd-weekly active-attnd"));?>  </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="box-one-lft-rght attnde-selectbox">
                                                                    <?php if(count($students)>0){?>
                                                                <?php $form=$this->beginWidget('CActiveForm',array('action'=>Yii::app()->createUrl('/attendance/studentSubjectAttendance/index'),'method'=>'GET')); ?>											
											...
											if($student!=NULL){ ?>
                                                            <div class="box-two">
                                                            <?php echo CHtml::link('Generate PDF', array('/attendance/studentSubjectAttendance/pdf','id'=>$stud_id,  'bid'=>$batch->id, 'date'=>$date),array('target'=>'_blank','class'=>'pdf_but')); ?>
                                                            </div>
                                                            <?php } ?>
                                                            </div>
                                        ...
                                        <div class="attendance-table-block">
                                            <div class="attendance-table-scroll">
												...
												if($set->is_elective == 2){ 
													...
													$student_elective	=	StudentElectives::model()->findByAttributes(array('student_id'=>$stud_id, 'batch_id'=>$bid, 'elective_group_id'=>$elective->elective_group_id)); 
										...
										<?php } ?>
                                                    ...
                                                    <?php 
                                                        ...
                                                        ?><div class="not-found-box"><?php
                                                        echo '<i class="os_no_found">'.Yii::t('app','No Class Timings').'</i>';
                                                        ?></div><?php
                                                    }
                                                }   
...
$( "#week" ).click(function() {
    ...
    $('.week-picker').datepicker({
        ...
        onSelect: function (dateText, inst) {
            setDates(this,1); 
			<?php $url = Yii::app()->createUrl("/attendance/studentSubjectAttendance/index",array('id'=>$batch->id, 'stud_id'=>$stud_id))?>
