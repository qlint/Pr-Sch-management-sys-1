...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->hiddenField($model,'from_date',array('value'=>$year.'-'.$month.'-'.$day));?>
		<?php echo $form->error($model,'from_date'); ?>
	</div>

	<div class="row">
		<?php //echo $form->labelEx($model,'employee_id'); ?>
		<?php echo $form->hiddenField($model,'requested_by',array('value'=>$emp_id)); ?>
	...
	<div class="row">
        ...
        <?php 
			...
			{
			echo $form->dropDownList($model,'employee_leave_type_id',CHtml::listData($leave_types, 'id', 'type'),array('empty'=>Yii::t('app','Select Type'),'ajax' => array(
								'type'=>'POST',
...
<div class="msg" id="leave_type" style="color:#F00"></div>
	...
	<div class="row" >
		...
		else
		{
			...
			echo $form->textField($model,'leave_type_id',array('value'=>$value,'disabled'=>true));	
		}
		?>
