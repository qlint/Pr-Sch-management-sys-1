...
<ul>                                    
 <li>
                            	<?php echo CHtml::link('<span>'.Yii::t('app','Clear All Filters').'</span>', array('onlineapplicants'), array('class'=>'a_tag-btn')); ?>                            
                            </li>
									...
									'method'=>'get',
                                        ...
                                        <li>
                                            <div onClick="hide('status')" style="cursor:pointer;"><?php echo Yii::t('app','Status');?></div>
                                                <div id="status" style="display:none; width:249px;" class="drop_search">
                                                <div class="droparrow"  style="left:10px"></div>
                                                <div class="filter_ul">
                                                    <ul>
                                                        <li class="Text_area_Box"> 
...
?>											</div>
                                            <div id="batch" style="display:none; color:#000; width: 420px; left: -44px;" class="drop_search">
                                                <div class="droparrow" style="left:54px;"></div>
                                               	 <div class="filter_ul">
                                                    <ul>
...
<?php /*?><?php                                                                                               													
													...
													<input type="submit" value="<?php echo Yii::t('app','Apply'); ?>" /><?php */?>
                                            </div>
                                        </li>
...
?>                                                                                                                   
    ...
    <?php                                     
                                        if(isset($_REQUEST['Students']['status']) and $_REQUEST['Students']['status']!=NULL){ 
											...
											elseif($_REQUEST['Students']['status'] == 1){
												$status = Yii::t('app','Approved');
											}
											elseif($_REQUEST['Students']['status'] == -1){
												$status = Yii::t('app','Disapproved');
											}
											elseif($_REQUEST['Students']['status'] == -3){
												$status = Yii::t('app','Waiting List');
											}
    ?>									
                                            <li><?php echo Students::model()->getAttributeLabel('status'); ?> : <?php echo $status; ?><a href="<?php echo Yii::app()->request->getUrl().'&status='?>"></a></li>								
    <?php									 
                                        }
    ?>									
        ...
        ?>                                               
                                                    ...
                                                    <div class="online_but onln-adm-stus">
                                                        <ul class="tt-wrapper">
                                                            ...
                                                            <?php if($student->status != 1 and $student->status != -3){ ?>
                                                                <li>
                                                                    <?php 
                                                                        if($student->status == -1){                                                                
                                                            ...
                                                            <?php if($student->status != 1){ ?>
                                                                <li>
                                                                    <?php echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', "#", array('submit'=>array('delete','id'=>$student->id,'flag'=>1), 'class'=>'tt-delete','confirm'=>Yii::t('app','Are you sure you want to delete this?'), 'csrf'=>true)); ?>
                                                                </li>
                                                            <?php } ?>
							...
							<div>
                                <div class="yellow_bx" style="background-image:none;width:600px;padding-bottom:45px;">
                                    <div class="y_bx_head" style="width:580px;">
                                    	<?php echo Yii::t('app','No Online Applicants'); ?>
                                    </div>                                   
                                </div>
                            </div>
<?php							
