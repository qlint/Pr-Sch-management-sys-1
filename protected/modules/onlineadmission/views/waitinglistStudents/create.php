        ...
        <td valign="top">
            <div class="cont_right formWrapper"> 
            	<div  class="page-header">                       
            		<h1><?php echo Yii::t('app','Create Waiting List'); ?></h1>
                </div>    
				...
				<div class="formConInner">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>                        	
                            ...
                            <td valign="bottom"><?php echo $student->getAttributeLabel('batch_id'); ?><span class="required"> *</span></td>
                        ...
                        {
                            echo $form->dropDownList($model,'batch_id',$data,array('encode'=>false,'options' => array($bid=>array('selected'=>true)),
                            'style'=>'width:170px;','empty'=>Yii::t('app','Select').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id")
                            )); 
                        }
                        else
                        {
                            echo $form->dropDownList($model,'batch_id',$data,array('encode'=>false,
