    ...
    <?php	
		...
		$this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
				...
				array('label'=>Yii::t('app','Waiting List').'<span>'.Yii::t('app','Manage Waiting List').'</span>', 'url'=>array('/onlineadmission/waitinglistStudents/list'),'linkOptions'=>array('class'=>'sm_ico' ),'active'=> ((Yii::app()->controller->id=='waitinglistStudents')  ? true : false),'linkOptions'=>array('id'=>'menu_3','class'=>'waiting-list_ico')),
				array('label'=>Yii::t('app','Incomplete Registrations').'<span>'.Yii::t('app','Manage Incomplete Registrations').'</span>', 'url'=>array('/onlineadmission/admin/incompleteReg'),'linkOptions'=>array('class'=>'sm_ico' ),'active'=> ((Yii::app()->controller->id=='admin') and (Yii::app()->controller->action->id == 'incompleteReg')  ? true : false),'linkOptions'=>array('id'=>'menu_3','class'=>'complt-regs_ico')),
				array('label'=>''.t('<h1>'.Yii::t('app','Student Leave Management').'</h1>')),
				array('label'=>Yii::t('app','Add Leave Type').'<span>'.Yii::t('app','Manage Leave Type').'</span>', 'url'=>array('/students/studentLeaveTypes'),'linkOptions'=>array('class'=>'addleave-type_ico'),'active'=> (Yii::app()->controller->id=='studentLeaveTypes')),
