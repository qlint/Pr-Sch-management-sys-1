...
<?php   $formId='student-categories-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentCategory/ajax_create')
    ...
    <div class="fancy_box_form">
        ...
        <span id="success-StudentCategories_name" class="hid input-notification-success  success-fancy"></span>
        ...
        <span id="success-StudentCategories_is_deleted" class="hid input-notification-success  success-fancy"></span>
