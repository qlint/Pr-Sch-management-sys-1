...
<?php	
	...
	<?php 														
						...
						if($check_flag == 1 ){
	?>                
							<?php echo $form->checkBox($model,'user_create',array('id'=>'user_create','checked'=>'true')); ?>
	<?php                
						}
						else{
	?>                
							<?php echo $form->checkBox($model,'user_create',array('id'=>'user_create','checked'=>$checked)); ?>
	<?php                
						}
	?>                
						<?php echo '<label>'.$form->labelEx($model,Yii::t('app','Don\'t create parent user')).'</label>'; ?>						
				</div>
		<?php } ?>                
				<div class="clear"></div>
