                ...
                <div class="search_btnbx">
                    ...
                    <div class="contrht_bttns">
                        <ul>
                            ...
                            <li><a href="javascript:void(0);" class="load_filter" onClick="hide('osload')"><span>
                        ...
                        <div class="filterbxcntnt_inner" style="border-bottom:#ddd solid 1px;">
                            <ul>
                                ...
                                <div onClick="hide('academic_yr')" style="cursor:pointer;"><?php echo Yii::t('app','Academic Status');?></div>
                                    <div id="academic_yr" style="display:none; width:230px; min-height:33px; left:-120px; padding-top:0px;" class="drop">
                                    <div class="droparrow"  style="left:140px"></div>
                                    <?php 
                                    echo CHtml::activeDropDownList($model,'academic_yr',array('all'=>Yii::t('app','All')),array('selected'=>'selected','prompt'=>Yii::t('app','In Progress'))); 
                                    ?>
                                    <input type="submit" value="<?php echo Yii::t('app','Apply'); ?>" />
                                    </div>
                                </li>
