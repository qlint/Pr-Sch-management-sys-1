...
<table width="100%" border="0" cellspacing="0" cellpadding="0">  
 ...
 <?php $data =StudentLeaveTypes::model()->findAll();
	...
	<div style="padding:20px 0 0 0px; text-align:left">
		 <?php	echo CHtml::ajaxSubmitButton(Yii::t('app','Save'),CHtml::normalizeUrl(array('studentAttentance/subjectwise','render'=>false)),array('dataType'=>'json','success'=>'js: function(data) {
					if (data.status == "success")
					{
					 $("#jobDialog").dialog("close");
					 if(data.flag==1)
					 {
						 //window.location.href = "'.Yii::app()->request->baseUrl.'/index.php?r=students/StudentAttentance/subwiseattentance"; 
