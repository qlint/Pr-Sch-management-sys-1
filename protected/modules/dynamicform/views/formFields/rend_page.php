                            ...
                            <div class="opnsl_actn_box1">
                                <div id="nextbtn">
									<?php if($flag==0)
										{
										?>
										<a href="javascript:void(0);" title="<?php echo Yii::t("app", "Add New Option");?>" class="add_new_row mailbox-menu-mangeup" style="font-size:12px;" data-row="<?php echo $last;?>"><strong><?php echo Yii::t("app", "+Add New");?></strong></a>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="opnsl_actn_box2"><?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('app','Save') : Yii::t('app','Save'),array('class'=>'formbut')); ?></div>
                        </div>
                    </div>
