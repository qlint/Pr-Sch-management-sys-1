        ...
        if($batch_id!="" && ExamFormat::model()->getExamformat($batch_id)== 2)
                            {?>
                                        ...
                                        <div style="float:left; width:480px;">
                                            ...
                                            echo CHtml::dropDownList('id','',$data,array('empty'=>Yii::t('app','Select'),'class'=>'form-control','onchange'=>'structureskill()','id'=>'skill', 'encode'=> false, 'options'=>array($sel=>array('selected'=>true))));                             
                                            ?>
                                        </div>
                                   <br><br>
