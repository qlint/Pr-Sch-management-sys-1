    ...
    <div class="opnsl_headerBox">
                <div class="opnsl_actn_box"> </div>
                    <div class="opnsl_actn_box">
                        ...
                        <?php } ?> 
                        <div class="opnsl_actn_box1"> <?php echo CHtml::link('<span>'.Yii::t('examination','Change').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>', array('/teachersportal/exams/allexam'),array('id'=>'add_exam-groups','class'=>'addbttn')); ?></div>
                    </div>
                </div>
<div>
	<?php
    ...
    if($exam_group_id==NULL){ // If $exam_group_id == NULL, list of exams will be displayed
		...
		$this->widget('zii.widgets.grid.CGridView', array(
			...
			'cssClassExpression' => '$data->is_published?"view_Schedule_grid":"no_Exam_grid"',
			'urlExpression'=>'$data->is_published ? '.$scheduleUrlExp.' : "#"',
			'header'=>'Schedule Published',
			...
			'cssClassExpression' => '$data->result_published ?"View_Results_grid":$data->is_published?"view_score_grid":"no_Exam_grid"',
