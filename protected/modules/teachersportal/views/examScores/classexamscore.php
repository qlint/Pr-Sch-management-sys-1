...
<table class="table table-bordered mb30">
					...
					?>
                    			<tr>
                                 <?php if(Configurations::model()->rollnoSettingsMode() != 2){
                                    ...
                                    <?php 
                                        if($sub->elective_group_id!=0)
                                        {
                                            ...
                                            if($studentelctive==NULL) 
                                            {
                                                $elective_flag=1;
                                            ?>
                                                <?php echo '<i><span style="color:#E26214;">'.Yii::t('app','Elective not assigned').'</span></i>  '.CHtml::link(Yii::t('app','Add now'),array('/teachersportal/course/electiveView','id'=>$batch_id)); ?>
                                            <?php
											$flag=1;
                                            }
											else
                                    ...
                                    {
                                        if($elective_flag==0){
                                            echo $form->textField($model,'remarks['.$k.']',array('encode'=>false,'size'=>60,'maxlength'=>255,'style'=>'width:200px','class'=>'form-control')); 
                                        }
                                    }else{
                                        echo $form->textField($model,'remarks['.$k.']',array('encode'=>false,'size'=>60,'maxlength'=>255,'style'=>'width:200px','class'=>'form-control')); 
                                    }
                ...
                <div class="opnsl_headerBox">
                    <div class="opnsl_actn_box"> </div>
                    <div class="opnsl_actn_box">
                <?php if($i!=1) echo CHtml::submitButton($model->isNewRecord ? Yii::t('app','Create') : Yii::t('app','Save'),array('class'=>'btn primary')); ?>
                    </div>
                </div>
