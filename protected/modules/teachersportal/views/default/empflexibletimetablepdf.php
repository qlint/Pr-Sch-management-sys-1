...
?>
   ...
   <div align="center" style="display:block; text-align:center;"><?php echo Yii::t('app','TEACHER TIMETABLE');?> - <?php echo $course_name->course_name; ?> (<?php echo $batch->name; ?>)</div>
    <div align="center" style="display:block; text-align:center;"><?php if(Configurations::model()->isSemesterEnabledForCourse($batch->course_id) == 1){
    	$semester = Semester::model()->findByAttributes(array('id'=>$batch->semester_id));
    	echo Yii::t('app','Semester Name').' &nbsp; : &nbsp;'.(($semester!=NULL)?$semester->name:'-');
    }?>
    </div>
