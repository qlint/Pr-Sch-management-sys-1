 ...
 <ul>
	...
	echo '<li><small class="pull-right messg_time">'.$date1.'</small>'.CHtml::link('<h4  class="sender">'.$data->subject.'</h4>', array('/portalmailbox/message/view','id'=>$data->conversation_id)).'<p>
               '.$data->text.'
                </p>';?>
