...
$time_tables	= TimetableEntries::model()->findAllByAttributes(array('class_timing_id'=>$_REQUEST['timing_id'], 'weekday_id'=>$_REQUEST['weekday_id'], 'batch_id'=>$_REQUEST['batch_id'], 'is_elective'=>2, 'employee_id'=>$employee->id));
...
?>
    <div class="view-dialog-popup">
        <table width="400" border="0" cellpadding="0" cellspacing="0" class="student-popup-table">
            <thead>
                <tr>
                    <th style="text-align:center; line-height:35px;"><?php echo Yii::t('app','Elective Name'); ?></th>
                </tr>
