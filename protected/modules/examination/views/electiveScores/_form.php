...
{?>
    ...
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('app','Clear All Scores').'</span>', "#", array('submit'=>array('electiveScores/deleteall','id'=>$_REQUEST['id'],'examid'=>$_REQUEST['examid'], 'elective'=>$_REQUEST['elective']), 'confirm'=>Yii::t('app','Are you sure you want to delete all scores ?.'), 'csrf'=>true,'class'=>'addbttn last'));?>
    </li>
