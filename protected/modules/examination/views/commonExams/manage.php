...
$this->breadcrumbs=array(
	...
	Yii::t('app','Common Exams')=>array('/examination/commonExams'),
	Yii::t('app','Manage')
);
?>
<?php
    ...
    <tr>
        ...
        <td valign="top">
            <div class="cont_right formWrapper">
                <h1><?php echo Yii::t('app','Manage Common Exam');?></h1>
...
<li><?php 
                                    if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_create->settings_value!=0)){
                                        echo CHtml::link('<span>'.Yii::t('app','Create Exam').'</span>', array('create'),array('class'=>'a_tag-btn')); 
                                    }
                                ?></li>                                    
</ul>
</div> 
                ...
                <div class="emp_right_contner">
                    <div class="emp_tabwrapper">
                        ...
                        <div>
                            ...
                            <?php echo $this->renderPartial('_form_subject', array('model'=>$model)); ?>
                        </div>
