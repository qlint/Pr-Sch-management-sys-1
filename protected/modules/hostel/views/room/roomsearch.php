...
.exp_but { right:57px; margin:0px 2px !important;}
</style>

<?php
$this->breadcrumbs=array(
	Yii::t('app','Rooms')=>array('/hostel'),
	Yii::t('app','Search Room'),
);?>
...
'ajax' => array(
  ...
  <tr>
   ...
   <tr>
	...
	'update'=>'#roomid',
	'data'=>'js:{floor:$(this).val(), "'.Yii::app()->request->csrfTokenName.'":"'.Yii::app()->request->csrfToken.'"}',)));?>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><strong><?php echo Yii::t('app','OR');?></strong></td>
  </tr>
   <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
