...
<div class="pageheader">
      <h2><i class="fa fa-download"></i> <?php echo Yii::t('app','Downloads'); ?> <span><?php echo Yii::t('app','Downloads here'); ?>...</span></h2>
...
<div class="people-item">
 ...
 <h5 class="subtitle">Download your file</h5>
<p>Displays all files.</p>           
...
'htmlOptions'=>array(
   ...
   <label></label>
	...
	if($files!=NULL)
	{
		...
		<td width="60">
        <div class="checkbox checkbox_custom">
        <input type="checkbox" id="demo_box_<?php echo $file->id+1;?>" name="Downfiles[]" class="css-checkbox dl-files" value="<?php echo $file->id;?>" />
        <label for="demo_box_<?php echo $file->id+1;?>" name="demo_lbl_<?php echo $file->id+1;?>" class="css-label"></label>
        </div>
        </td>
		<td width="300">
		...
		<?php 
			if($file->created_by==Yii::app()->user->Id)
				echo '<img src="images/arrow_right.png" style="margin:0px 10px 0px 10px" />';
			else
...
<div class="opnsl_actn_box1">   <input type="submit" onclick="return validateForm();" value="<?php echo Yii::t('app','Download'); ?>" class="btn btn-danger" /></div>
</div>
</div>
