    ...
    <tr>
        ...
        <td valign="top">
            <div class="cont_right formWrapper">
            	<h1><?php echo Yii::t('app','Approved Leave Requests');?></h1>
                ...
                <div class="pdtab_Con" style="width:100%">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="pdtab-h">
                            ...
                            <td align="center" height="18" width="175"><?php echo Yii::t('app','Approved By');?></td>
                        ...
                        ?>
                            <tr>
                                <td colspan="7" align="center"><?php echo Yii::t('app', 'No approved requests');?></td>
                            </tr>
                        <?php
                        }
                        ?>
