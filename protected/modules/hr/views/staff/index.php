...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="cont_right formWrapper">
        <h1><?php echo Yii::t('app','Manage Staff');?></h1>
                                 ...
                                 <td align="center" class="os-button-column">
                                 	<ul class="tt-wrapper">							 
										 <?php
										 	...
										 	echo '<li>'.CHtml::link('<span>'.Yii::t('app', 'View').'</span>',array('/hr/staff/view','id'=>$list_1->id), array('class'=>'view')).'</li>'; 							
										 	 echo '<li>'.CHtml::link('<span>'.Yii::t('app', 'Edit').'</span>', array('/hr/staff/update','id'=>$list_1->id), array('class'=>'edit')).'</li>'; 
                                             echo '<li>'.CHtml::link('<span>'.Yii::t('app', 'Delete').'</span>', "#", array('submit'=>array('/hr/staff/delete','id'=>$list_1->id), 'confirm'=>Yii::t('app','Are you sure you want to delete the staff?'), 'csrf'=>true, 'class'=>'delete')).'</li>';
                                         ?>  
									</ul>                                          
                                 </td>
