...
class LeaveTypesController extends RController
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['LeaveTypes']))
		{
			$model->attributes=$_POST['LeaveTypes'];
			if($model->save()){
				Yii::app()->user->setFlash('successMessage', Yii::t('app','Leave Type Updated Successfully'));
				$this->redirect(array('index'));
			}
		}
	...
	public function actionDelete($id)
	{
		...
		{ 
			...
			if($model){
				$model->is_deleted = 1;
				if($model->save()){
					Yii::app()->user->setFlash('successMessage', Yii::t('app','Leave Type Deleted Successfully'));
				}
			}
	...
	{
		$dataProvider=new CActiveDataProvider('LeaveTypes');
