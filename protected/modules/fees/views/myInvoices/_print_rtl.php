    ...
    <tr>
        ...
        <td valign="middle" >
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="listbxtop_hdng first" style="text-align:right; font-size:22px; padding-left:10px;">
...
<div class="attendance_table">
    <table width="380" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            ...
            ?>
            <tr>
                <td colspan="6" align="left" style="padding-right:10px;"><?php echo Yii::t('app','Sub Total').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></td>
                <td align="center"><?php echo number_format($sub_total, 2);?></td>
            </tr>
            <tr>
                <td colspan="6" align="left" style="padding-right:10px;"><?php echo Yii::t('app','Discount').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></td>
                <td align="center"><?php echo ($discount_total!=0)?number_format($discount_total, 2):"-";?></td>
            </tr>
            <tr>
                <td colspan="6" align="left" style="padding-right:10px;"><?php echo Yii::t('app','Tax').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></td>
                <td align="center"><?php echo ($tax_total!=0)?number_format($tax_total, 2):"-";?></td>
            </tr>
            <tr>
                <td colspan="6" align="left" style="padding-right:10px;"><?php echo Yii::t('app','Total').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></td>
