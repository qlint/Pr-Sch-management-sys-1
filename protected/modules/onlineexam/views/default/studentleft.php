...
<?php } ?>              
           ...
           <?php
			...
			{
	            $actions= array('exam', 'cbsc', 'examList', 'examTimetable');
				$module= array('onlineexam');
			   	if(Yii::app()->controller->action->id=='exams' or in_array(Yii::app()->controller->action->id,$actions) or in_array(Yii::app()->controller->module->id,$module))
				{
					echo '<li class="active">';
