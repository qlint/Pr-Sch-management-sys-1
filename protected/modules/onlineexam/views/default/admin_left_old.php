...
<div id="othleft-sidebar">
    ...
    <ul>
        <li class="<?php if(Yii::app()->controller->id=='dashboard' && Yii::app()->controller->module->id=='onlineexam') { echo "list_active"; } ?>" ><?php echo CHtml::link(Yii::t('app','Dashboard').'<span>'.Yii::t('app','Online Examination Dashboard').'</span>',array('/onlineexam/dashboard/'),array('class'=>'exame-result_ico','active'=>(Yii::app()->controller->id=='dashboard' && Yii::app()->controller->module->id=='onlineexam'))); ?></li>  
        <li class="<?php if(Yii::app()->controller->id=='exams' && Yii::app()->controller->module->id=='onlineexam') { echo "list_active"; } ?>" ><?php echo CHtml::link(Yii::t('app','Online Exams').'<span>'.Yii::t('app','Online Examination List').'</span>',array('/onlineexam/exams/'),array('class'=>'exame-result_ico','active'=>(Yii::app()->controller->id=='exams' && Yii::app()->controller->module->id=='onlineexam'))); ?></li>  
    </ul>
    ...
    <?php			
        ...
        if(isset($_REQUEST['id']) and $_REQUEST['id']!=NULL)
        {
            ...
            'items'=>array(
                            ...
                            array('label'=>''.Yii::t('app','Set grading levels').'<span>'.Yii::t('app','Grading Levels for the').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>', 'url'=>array('/examination/gradingLevels','id'=>$_REQUEST['id'],) ,'linkOptions'=>array('id'=>'enroll_p','class'=>'exm-gradebook_ico '),
                            ...
                            array('label'=>Yii::t('app','Select').' '.Yii::app()->getModule("students")->labelCourseBatch().'<span>'.Yii::t('app','Select').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','and exam').'</span>', 'url'=>array('/examination/exam','id'=>$_REQUEST['id']),'linkOptions'=>array('class'=>'ne_ico'),
                                    'active'=> ((Yii::app()->controller->id=='exam') && (in_array(Yii::app()->controller->action->id,array('index'))) or (Yii::app()->controller->module->id=="examination" && Yii::app()->controller->id=='exams') )  ? true : false
                                ),
                            ),
              ));
        }
        ...
        ?>
            <ul>
                ...
                <li class="<?php if(Yii::app()->controller->id=='gradingLevels') { echo "list_active"; } ?>" >
                    <?php echo CHtml::link(Yii::t('app','Default Grading Levels').'<span>'.Yii::t('app','Set Default Grading Level').'</span>',array('/examination/gradingLevels/list','key'=>'NULL'),array('class'=>'gradinglevels_ico','active'=>(Yii::app()->controller->id=='gradingLevels'))); ?>
                </li> 
            </ul>
        ...
        ?>
                ...
                <ul>                               
                    ...
                    <?php   if($settings_model!=NULL){ ?>
                        <li class="<?php if(Yii::app()->controller->id=='exam' and (Yii::app()->controller->action->id=='gradeSettings' or Yii::app()->controller->action->id=='settings')) { echo "list_active"; } ?>"><?php echo CHtml::link(Yii::t('app','CBSE Exam Settings').'<span>'.Yii::t('app','View CBSE Exam Settings').'</span>',array('/CBSCExam/exam/gradeSettings', 'id'=>$settings_model->id),array('class'=>'cbscgrad-exmsetng_ico')); ?></li>  
                    <?php } 
                    else{?>                 
