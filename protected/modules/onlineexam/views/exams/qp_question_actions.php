<div class="online-Q-list-action">
    <div class="Qstn-actn-ul Qstn-actn-posion-left">
        <ul>
            ...
            if(!$exists){
            ?>
            <li><?php echo CHtml::link(Yii::t('app','Edit'), array('exams/updateQp','id'=>$data->id), array('title'=>Yii::t('app', 'Edit Question'),'class'=>'Q-edit-icon')); ?></li>
            <li><?php echo CHtml::link(Yii::t('app','Delete'), "#", array("submit"=>array('/onlineexam/exams/deleteQp','id'=>$data->id),'confirm' => Yii::t('app', 'Are you sure?'), 'csrf'=>true, 'class'=>'Q-delete-icon')); ?></li>
            <?php } ?>
