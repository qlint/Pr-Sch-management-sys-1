    ...
    <tr>
        ...
        <td valign="top">
            <div class="cont_right formWrapper">
                <h1><?php echo Yii::t('app', 'Add Questions for Exam').' - '.$model->name; ?></h1>
                <div class="formCon">
                    <div class="formConInner">
                        <?php
                            ...
                            $this->renderPartial('qp_add_question_form', array('model'=>$q_model));?>                 
                    </div>
                </div>                
            </div>               
        </td>
...
{ 
    ...
    $.ajax({
		type:'POST',
		url:'<?php echo Yii::app()->createUrl('/onlineexam/exams/save');?>',
