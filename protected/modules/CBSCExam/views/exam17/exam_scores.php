                	...
                	<div class="header-box">
                        ...
                        <div class="header-box-two">
                             <div class="back-btn">
								 ...
								 echo CHtml::link("<span>".Yii::t("app", "Back")."</span>", array('/CBSCExam/exam17/create','exam_group_id'=>$exam->exam_group_id,'id'=>$_REQUEST['id']), array('class'=>'back-bttn fa ')); ?>                                
                             </div>
                        </div>
                	</div>
                ...
                <div class="emp_right_contner">
                    <div class="emp_tabwrapper">
                        ...
                        <div class="emp_cntntbx" style="padding-top:0px;">
                            <?php echo $this->renderPartial('exam_scores_form', array('model'=>$model)); ?> 
