                           ...
                           <?php
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
								...
								'columns' => array(
									...
									'urlExpression'=>'Yii::app()->createUrl("/CBSCExam/exams/create",array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))',
									...
									*/
									...
									'buttons' => array(
												...
												'url'=>'Yii::app()->createUrl("/CBSCExam/exam17/create", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
												...
												'url'=>'Yii::app()->createUrl("/CBSCExam/exam17/publishdate", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
												...
												'url'=>'Yii::app()->createUrl("/CBSCExam/exam17/publishresult", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
 ...
 //VIEW
    ...
    $('.fan_view').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=CBSCExam/exam17/returnView",
...
//UPDATE
    ...
    $('.fan_update').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=CBSCExam/exam17/returnForm",
...
// DELETE
    ...
    $('.fan_del').each(function(index) {
        ...
        deletes[id] = function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=CBSCExam/exam17/ajax_delete",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                    $("#exam-groups-grid").addClass("ajax-sending");
                },
