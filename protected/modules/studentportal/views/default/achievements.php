...
<div class="people-item">
	 ...
	 $documents = Achievements::model()->findAllByAttributes(array('user_id'=>$student->id,'user_type'=>'1'));
	 ?>           
	...
	?>
    	<tr>
        	<td colspan="5" class="table_nothingFound"><?php echo Yii::t('app','No achievements added!');?></td>
        </tr>
    <?php
	}
    ?>
