...
<script type='text/javascript' src='<?php echo Yii::app()->request->baseUrl; ?>/js/portal/fullcalendar/fullcalendar.js'></script>
     ...
     <div class="contentpanel">
		  ...
		  <div class="row">	
          <div class="col-lg-7 rtl-colm" style="padding-bottom:20px;">
                  ...
                  <ul>
                            ...
                            ?>
                               <li>                                  
                                    ...
                                    <div style="position:relative;" class="stripbx "><div  class="strip-rtl"style=" background-color:<?php echo $event_type->colour_code; ?>"></div><?php echo $d; ?> <span><?php echo date('M', mktime(0, 0, 0, $m, 10));; ?></span></div>                   
                                     </div>
...
$(document).on('click', "span.fc-button-next,span.fc-button-prev,span.fc-button-today", function() {
	...
	var year_int = date.getFullYear();
     $.ajax({
		 url:"<?php echo Yii::app()->createUrl('/studentportal/default/currentEvents'); ?>",
