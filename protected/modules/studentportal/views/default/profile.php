...
?>                    
                ...
                <a href="javascript:void(0);" id="std_image" data-url=""><div class="upload"></div></a>
            ...
            <?php echo CHtml::link('<span>'.Yii::t('app','Edit Profile').'</span>',array('editprofile'),array('class'=>'btn btn-xs prtl_btn btn_edit_prfl')); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
											...
											if($fields){
												foreach($fields as $key => $field){							
													if($field->form_field_type!=NULL){
														if(FormFields::model()->isVisible($field->varname,'Students','forStudentPortal')){
										?>    
															<tr>		
                                            ...
                                            <td>
                                                <?php 	
                                                    ...
                                                    if($emergency_contact != NULL){
                                                        echo $emergency_contact->parentFullName("forStudentPortal");
                                                    }
                                                    else{
                                                        echo '-';
                                                    }
                                            ...
                                            <thead>
                                                <?php if(FormFields::model()->isVisible("fullname", "Guardians", "forStudentPortal")){ ?>
                                                    <tr>	
                                                        ...
                                                        <td><?php echo strtoupper($guardian->parentFullName("forStudentPortal")); ?></td>
                                                    </tr>
                                                <?php } ?> 
                                                ...
                                                <?php 
                                                    ...
                                                    if($fields){
                                                        foreach ($fields as $key => $field){							
                                                            if($field->form_field_type!=NULL){
                                                                if(FormFields::model()->isVisible($field->varname,'Guardians','forStudentPortal')){
                                                                    ?>    
                                                                        <tr> 
...
<input type="hidden" value="0" id="custom-id" name="custom-id" />
...
$('#std_image').jupload({	
	url:<?php echo CJavaScript::encode(Yii::app()->createUrl('/studentportal/default/studentPicUpload',array('id'=>$student->id)))?>,		
