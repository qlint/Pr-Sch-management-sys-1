     ...
     <div class="contentpanel">
		...
		<?php } ?>	
                        ...
                        <div class="people-item">
                            ...
                            <?php 
                            if(isset($student->batch_id) && ExamFormat::model()->getExamformat($student->batch_id)==2)
                            { 
                            ?>
<div class="button-bg">
...
<div class="top-hed-btn-right">
                                    <ul>
                                        <li>
                                            <?php echo CHtml::link('<span>'.Yii::t('app','View Results').'</span>',array('/studentportal/default/cbsc'),array('class'=>'btn btn-primary'));?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
