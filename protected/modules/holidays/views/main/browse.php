...
.opnsl_popupFormField input[type="text"], textArea, select{
    border: 1px solid #dddddd;
    border-radius: 0px !important;
    box-shadow: 0 0px 0px #e2e3e3 inset !important;
    padding: 5px;
    width: 100% !important;
...
<div class="form">
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="3" style="font-size:12px;">
  	<tr>
    	<td>
        <div class="opnsl_popupFormField"
		<?php
        echo CHtml::hiddenField("EventCal_id", 0);
        echo CHtml::label(Yii::t('app', 'Title').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', "EventCal_title");?><?php
    ...
    <tr>
    	<td>
		<?php
		echo CHtml::label(Yii::t('app','Description'), "EventCal_desc"); ?>
		<?php
        echo CHtml::textArea('EventCal_desc','',array('rows'=>6,));
		 ?>
         </td>
  	</tr>
