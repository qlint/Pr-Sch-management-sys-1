...
$item_detail = PurchaseSupply::model()->findByAttributes(array('id'=>$_REQUEST['id']));
?>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-border-new">
	<tr>
        ...
        <td align="center"><?php echo $item_detail->item_id;?></td>
    </tr>
    <tr>
        <td width="200px;" align="center"><strong><?php echo Yii::t('app','Vendor'); ?></strong></td>
        <td align="center"><?php $vendor = PurchaseVendors::model()->findByAttributes(array('id'=>$item_detail->vendor_id));
													 echo $vendor->first_name.' '.$vendor->last_name; ?></td>
    </tr>
    
    <tr>
        <td width="200px;" align="center"><strong><?php echo Yii::t('app','Quantity'); ?></strong></td>
        <td align="center"><?php echo $item_detail->quantity; ?></td>
    </tr>
    
     <tr>
        <td width="200px;" align="center"><strong><?php echo Yii::t('app','Price'); ?></strong></td>
        <td align="center"><?php echo $item_detail->price;?></td>
    </tr>
    
     <tr>
        <td width="200px;" align="center"><strong><?php echo Yii::t('app','Payment'); ?></strong></td>
        <td align="center"><?php echo $item_detail->payment_id;?></td>
    </tr>
