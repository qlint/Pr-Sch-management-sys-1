            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top" width="75%">
                        ...
                        <h1><?php echo Yii::t('app','Calendar');?></h1>
                        <div style="position:absolute; width:30%; z-index:10; top:47px; left:24px; font-size:14px;">
                        	<?php
                        ...
                        <div id="calendar" style="width:100%; padding-top:38px"><?php  echo $content; ?></div>
                            <!--<div style="width:100%;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
