	...
	<div class="formCon">
     <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
        	<tr>
                <td>&nbsp;</td>
                <td style="width:200px;"><strong><?php echo Yii::t('app','Academic Year');?></strong><span class="required"> *</span></td>
                <td>&nbsp;</td>
                <td>
				<?php
            ...
            <tr>
                ...
                echo CHtml::dropDownList('semester_id',(isset($_GET['sid']))?$_GET['sid']:'',$data,array('prompt'=>Yii::t('app','Select'),
					'style'=>'width:200px;',
					'ajax' => array(
					'type'=>'POST',
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="width:100px;"><strong><?php echo Yii::app()->getModule('students')->fieldLabel("Students", "batch_id");?></strong><span class="required"> *</span></td>
                <td>&nbsp;</td>
                 <?php 
                ...
                if($batch_id!=NULL)
                {
                    ...
                    'update'=>'#exam_id',
                    'data'=>'js:{batch:$(this).val(), "'.Yii::app()->request->csrfTokenName.'":"'.Yii::app()->request->csrfToken.'"}',),'style'=>'width:200px;',
