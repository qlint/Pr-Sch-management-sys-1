    ...
    <!-- Batch Assessment Report -->
    	...
    	<table width="100%" cellspacing="0" cellpadding="0" class="attendance_table">
        	...
        	<tr class="tablebx_topbg" style="background-color:#DCE6F1;">
                ...
                <?php } ?>
                <?php
				$exams = CbscExams17::model()->findAllByAttributes(array('exam_group_id'=>$_REQUEST['examid']));
				$examgrp = CbscExamGroup17::model()->findByAttributes(array('id'=>$_REQUEST['examid']));
