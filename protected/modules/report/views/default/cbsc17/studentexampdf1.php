                ...
                <table class="table-grade-box" width="100%" cellpadding="0" cellspacing="0" border="1">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th><?php echo Yii::t('app','Third Term Exam');?>(40)</th>

                            <th><?php echo Yii::t('app','Mark Obtained');?>(60)</th>   
...

                                {
                                    ...
                                    if($scores!=NULL)                            
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo CbscExamScores17::model()->getClass1Grade($scores->total); ?></td>                
...
<table class="table-grade-box table-box-mrgn tablegrade-spc " width="100%" cellpadding="0" cellspacing="0" border="1">
    ...
    <tr>
        ...
        <h4>Grading scal for co-scholastic and Discipline</h4>
