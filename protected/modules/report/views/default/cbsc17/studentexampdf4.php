...
$batch_student          = 	BatchStudents::model()->findByAttributes(array('student_id'=>$student->id,'batch_id'=>$_REQUEST['bid']));
$student_visible_fields =   FormFields::model()->getVisibleFields('Students', 'forStudentProfile');
$semester				=	Semester::model()->findByAttributes(array('id'=>$batch->semester_id));
$exam_groups   		    =   CbscExamGroup17::model()->findAllByAttributes(array('batch_id'=>$_REQUEST['bid'],'date_published'=>1,'result_published'=>1,'type'=>2,'class'=>4));
?>
...
<tr>
    ...
    <th><?php echo Yii::t('app','Student Name4')." : ";?></th>
...
<tr><th><?php echo Yii::t('app','ACADEMIC PERFORMANCE OF THE STUDENT 1');?>
...
<table class="table-stl" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	$examformat	= 	ExamFormat::model()->getExamformat($_REQUEST['bid']);
    if($subjects!=NULL){
		$sl=1;
        foreach($subjects as $subject){
            $sub1_total	=	0;
			$sub2_total	=	0;
            if($examformat == 1 and $subject->split_subject==1){ 
