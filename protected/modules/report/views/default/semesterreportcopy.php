                ...
                <div class="formCon">
                    <div class="formConInner">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
                            <tr>
                                <td width="1%">&nbsp;</td>
                                <td width="10%"><strong><?php echo Yii::t('app','Name');?></strong></td>
                                <td>&nbsp;</td>
                                <td width="39%"> 
                                    ...
                                    <?php echo CHtml::ajaxLink('',array('/site/explorer','widget'=>'sem_ex'),array('update'=>'#explorer_handler'),array('id'=>'explorer_student_name','class'=>'exp_but'));?>
                                    </div>
                                </td>
                                <td width="50%"></td>
                            </tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><strong><?php echo Yii::t('app','Semester');?></strong></td>
                                <td>&nbsp;</td>
                                <td>
                                    <div>
										<?php 
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><strong><?php echo Yii::t('app','Batch');?></strong></td>
                                <td>&nbsp;</td>
                                <td>
                                    <div>
										<?php 
										...
										echo CHtml::dropDownList('batch_id','',$batch_data,array('empty' => Yii::t('app','Select Batch'),'options' => array($batch_id=>array('selected'=>true)),)); ?>
                                    </div>
                                </td>
                            </tr>
                        </table>
												...
												if($score!=NULL)
													{
														if($subject->split_subject == 1){
														   ...
														   ?></span></td>             
                                                                     ...
                                                                     <tr>           
                                                                        <td  class="header-td1"><?php echo $sub_value[0];?></td>
