...
<div class="sent_table_image_left"></div>
    <form id="select-group-form">
        ...
        <td>
			...
			?>
			<div style="padding-top:10px; width:94%; margin-top:10px;" class="notifications nt_red"><i><?php echo Yii::t('app','No groups found').'. '.CHtml::link(Yii::t('app','Create Now'), array('/sms/contactgroups'), array('target'=>''));?></i></div>
			<?php
			}
			?>
            </div>
