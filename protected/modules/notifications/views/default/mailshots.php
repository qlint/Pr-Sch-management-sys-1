...
<ul>                                    
                                   <li>
                                    <?php echo CHtml::link('<span>'.Yii::t('app','Delete All').'</span>', "#", array("submit"=> array('default/deleteallmailshot'),array(),'confirm'=>Yii::t('app', 'Are You Sure?'),'class'=>'a_tag-btn', 'csrf'=>true));?>
                                    </li>                                    
</ul>
</div> 
...
<tbody>
	...
	?>
    			<tr>
                	<td><?php echo $k; ?></td>
                    <td><?php echo CHtml::link(ucfirst($sub), array('default/senddraft','id'=>$models->id)); ?></td>
                    <td><?php echo CHtml::encode($date.' '.$time); ?></td>
                    <td>
                    	<?php 
							echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', "#", array("submit"=>array('default/deletemailshot','id'=>$models->id),'confirm' => Yii::t('app', 'Are you sure?'), 'csrf'=>true));
						?>	
                    </td>
                </tr>
    <?php	
	...
	?>
    		<tr>
            	<td class="nothing-found" colspan="4"><?php echo Yii::t('app', 'No mailshots saved!'); ?></td>
            </tr>
    <?php	
		}
	?>
