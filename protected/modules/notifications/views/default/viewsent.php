                    	...
                    	<div  class="cont_right formWrapper">
						 ...
						 ?>
                            <div class="view_sent_mail">
                            	<!-- news box starts-->
                                <?php  ?>
								<h4><?php echo Yii::t('app', 'Subject :');?> <?php echo $model->subject; ?></h4>
                            	<div class="to_mail">
                                <p><span><b><?php echo Yii::t('app', 'To :');?></b><?php if(in_array("1",$user)){ echo Yii::t('app', 'Teachers');?>,<?php } ?>
                                    <?php if(in_array("2",$user)){echo Yii::t('app', 'Parents');?>,<?php } ?>
                                    <?php if(in_array("3",$user)){echo Yii::t('app', 'Students'); } ?></span></p>
                                    
                                <p><span><b><?php echo Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.':';?>  </b></b><?php if(in_array("0",$batch)){ echo Yii::t('app', 'All').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"); }else{ foreach($model2 as $models){ echo $models->name;?>, &nbsp;<?php }} ?>  </span></span>
                                
                              <p> <span> <b><?php echo Yii::t('app', 'Attachments :');?> </b>&nbsp;
                                         <?php 	foreach($attachments as $attachment){  
										 echo CHtml::link($attachment->file, array('default/download','id'=>$attachment->id,'mail_id'=>$attachment->mail_id));?>&nbsp; , <?php } ?></span></p>
									...
									echo CHtml::encode($date.' '.$time); ?></div>
                                    	 ...
                                    	 <p class="mssg-border"><?php echo $model->message; ?></p>
