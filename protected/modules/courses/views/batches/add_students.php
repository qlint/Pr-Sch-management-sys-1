									...
									//course id   
                                            echo CHtml::dropDownList('cid',$cid,$data,
                                                    array('prompt'=>Yii::t('app','Select Course'),
                                                            ...
                                                            'update'=>'#batch_id',
                                                            'data'=>array('cid'=>'js:this.value','bid'=>$_GET['id'],Yii::app()->request->csrfTokenName=>Yii::app()->request->csrfToken)
                                            ))); 
                                    ?>                                   
                                </li>
                                <li class="Text_area_Box-two">
									...
									if($_GET['cid'] !=NULL or $_GET['cid'] !='') {
										...
										$data1 = CHtml::listData($data,'id','name');
                                    ...
                                    $batch_label = Yii::app()->getModule('students')->fieldLabel("Students", "batch_id");
                                    echo CHtml::activeDropDownList($model,'batch_id',$data1,array('encode'=>false,'id'=>'batch_id','prompt'=>Yii::t('app','Select')." ".$batch_label));
