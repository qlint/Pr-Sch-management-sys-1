			  ...
			  <?php } ?>
							...
							if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and ($is_insert->settings_value!=0 or $is_inactive->settings_value!=0))){
								?>
                                    <td>
                                        ...
                                        <div  id="<?php echo $i; ?>" class="opnsl_act_but"> <?php echo Yii::t('app','Actions');?> </div>
                                        ...
                                        if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_insert->settings_value!=0))
                                        {
											...
											<?php  
											echo CHtml::ajaxLink(
													Yii::t('app','Add Leave').'<span>'.Yii::t('app','Add leave for this student').'</span>',
													$this->createUrl('/courses/studentAttentance/studentLeave'),
													array(
													...
													array(
														'id'=>'edit-attendance-'.$posts_1->id,
														'class'=>'addevnt',
														 'title'=>Yii::t('app','Update')
													)
												);
											/*echo CHtml::link(Yii::t('app','Add Leave').'<span>'.Yii::t('app','Add leave for this student').'</span>', 
                  ...
                  <?php
					if(isset($_REQUEST['id']))
					{
						...
						//$posts    = 	BatchStudents::model()->BatchStudent($_REQUEST['id']); 
...
<td><?php
                        ...
                        <td ><div style="position:absolute;">
                            <div  id="<?php echo $j; ?>" class="act_but-new"> <?php echo Yii::t('app','Actions 2');?> </div>
                            <div class="act_drop" id="<?php echo $j.'x'; ?>">
                              <div class="but_bg_outer"></div>
                              <div class="but_bg">
                                <div  id="<?php echo $j; ?>" class="act_but_hover"> <?php echo Yii::t('app','Actions 1');?> </div>
                              </div>
                              <ul>
                                <?php
