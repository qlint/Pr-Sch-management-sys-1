...
?>
 ...
 ?>   
     <div align="center" style="display:block; text-align:center;">
         <h3><?php echo $display_date; ?><br /> <?php echo Yii::t('app','Daily Wise Student Attendance');?>(
		 	 <?php
...
<?php 
																			foreach($students as $student){
																				...
																				$batch_student=BatchStudents::model()->findByAttributes(array('student_id'=>$student->id, 'batch_id'=>$_REQUEST['batch'], 'status'=>1));
