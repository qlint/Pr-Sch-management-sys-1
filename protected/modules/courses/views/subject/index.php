...
<!-- END div class="edit_bttns" -->
								...
								$exam_format = ExamFormat::model()->getExamformat($_REQUEST['id']);
                                $del_con = Yii::t('app', 'Are you sure you want to delete this subject(Also delete this subject related exam Scheduled and Exam marks)?');
									   ...
									   array(
                                        ...
                                        'max_weekly_classes',
										 ...
										 array(
											...
											'visible'=>($exam_format == 1)?true:false, 
										),
										array(
