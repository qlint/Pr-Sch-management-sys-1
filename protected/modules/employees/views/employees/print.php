...
?>
    ...
    <table class="table_listbx" width="100%" cellspacing="0" cellpadding="0">
         ...
         <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="border:none;" width="260"><?php echo Employees::model()->getTeachername($model->id); ?></td>
                   ...
                   <?php 
                    ...
                    { 
                       ...
                       {
                       ?>
                       <img  src="images/s_prof_fe_image.png" width="150" style="border:4px #CCCCCC solid;" alt="<?php echo Employees::model()->getTeachername($model->id); ?>"/> 
                       <?php 
                       } 
                       else 
                       { ?>
                       
                       <img  src="images/s_prof_m_image.png" width="150" style="border:4px #CCCCCC solid;" alt="<?php echo Employees::model()->getTeachername($model->id); ?>"/> 
