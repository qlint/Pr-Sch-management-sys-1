    ...
    <div class="formCon">
        <div class="formConInner">
            ...
            <table width="50%" border="0" cellspacing="0" cellpadding="0">
                ...
                <!-- weekdays -->
                <?php
                if(Configurations::model()->timetableFormat($_REQUEST['id'])==2){	// if timetable format is flexible
                ?>
                    <tr>
                        <td colspan="7">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <?php
                        $batch_weekdays = Weekdays::model()->findAll("batch_id=:x AND weekday<>0", array(':x'=>$_REQUEST['id']));
