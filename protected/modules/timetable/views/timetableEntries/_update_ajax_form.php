...
foreach($models as $model){ 
	...
	$elective =  Electives::model()->findByAttributes(array('id'=>$model->subject_id,'is_deleted'=>0));
	  ...
	  ?>
    <tr>
        <td width="30%"><strong><?php echo CHtml::activeLabel($model,$elective->name);?></strong><input type="hidden" name="elective_id[]" value="<?php echo $elective->id ?>"/></td>
        <td width="70%">
			...
			<?php 
					...
					$data,
					array('prompt'=>Yii::t('app','Select Teacher'),'style'=>'width:200px;','id'=>'employee_id'.$i,'class'=>'elective-drop',
