...
function getyear()
{
	...
	if(year_id == '') // Some year is selected
	  {
...
function getcourse() // Function to get course and update the search form
{
	...
	if(year_id != '' && course_id == '') // Some year is selected
	  {
		  window.location= 'index.php?r=/timetable/weekdays/fulltimetable&yid='+year_id;
	  }
...
function getmode() // Function to get mode and the dependent dropdown after selecting mode
{
	...
	if(course_id != '' && batch_id != '' && mode_id == '') // Some year is selected
	  {
		 window.location= 'index.php?r=/timetable/weekdays/fulltimetable&yid='+year_id+'&cid='+course_id+'&bid='+batch_id;
	  }
...
function getday() // Function to get day
{
	...
	if(course_id != '' && batch_id != '' && mode_id != '' && day_id == '') // Some year is selected
	  {
		 window.location= 'index.php?r=/timetable/weekdays/fulltimetable&yid='+year_id+'&cid='+course_id+'&bid='+batch_id;
	  }
                                            ...
                                            <td>
                                               ...
                                               // echo CHtml::dropDownList('batch_id','',array(),array('prompt'=>'Select Batch','id'=>'batchid','submit'=>array('/report/default/studentattendance')));
                                                if(isset($_REQUEST['bid']) and $_REQUEST['bid']!=NULL)
                                                {
                                                    ...
                                                    echo CHtml::dropDownList('bid','',$batch_list,array('encode'=>false,'prompt'=>Yii::t('app','Select Batch'),'id'=>'batchid','style'=>'width:190px;','options'=>array($_REQUEST['bid']=>array('selected'=>true)),'onchange'=>'getbatch()'));
                                                }
                                                else
                                                {
                                                    echo CHtml::dropDownList('bid','',array(),array('encode'=>false,'prompt'=>Yii::t('app','Select').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"),'id'=>'batchid','style'=>'width:190px;','onchange'=>'getbatch()'));
                                                }
                                                ?>
                                            </td>
                                        </tr>
															...
															<tr>
																...
																<td>
																	<?php
																		...
																		echo Yii::t('app','Class Teacher').' : '.Employees::model()->getTeachername($classteacher->id);
																	?>
																</td>
                                                                <td>
                                                                	<?php
																		...
																		if($timing!=NULL){
																			echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/pdf','id'=>$_REQUEST['bid']),array('class'=>'pdf_but','target'=>'_blank')); 
																		}
																	?>
                                                                </td>
															</tr>
                                                	...
                                                	<tr>
                                                        <td>
                                                            <?php
                                                                ...
                                                                if($timing!=NULL){
                                                                    echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/fullpdf','id'=>$_REQUEST['bid'],'yid'=>$_REQUEST['yid'],'cid'=>$_REQUEST['cid'],'mode'=>$_REQUEST['mode']),array('class'=>'pdf_but','target'=>'_blank')); 
                                                                }
                                                            ?>
                                                        </td>
                                                     </tr>
                                                	...
                                                	<tr>
                                                        <td>
                                                            <?php
                                                                ...
                                                                if($timing!=NULL){
                                                                    echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/fullpdf','id'=>$batch->id,'yid'=>$_REQUEST['yid'],'cid'=>$_REQUEST['cid'],'mode'=>$_REQUEST['mode'],'day'=>$_REQUEST['day']),array('class'=>'pdf_but','target'=>'_blank')); 
                                                                }
                                                            ?>
                                                        </td>
                                                     </tr>
