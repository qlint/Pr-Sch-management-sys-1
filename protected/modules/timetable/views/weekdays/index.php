...
<ul>                                    
<li><?php echo CHtml::link('<span>'.Yii::t('app','Time Table').'</span>',array('weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'a_tag-btn'));?></li>                                    
</ul>
</div> 
</div> 
                                ...
                                <div class="formConInner">
                                    ...
                                    <div>                                    
                                        <div style="padding-top:10px; font-size:14px; font-weight:bold;">
                                            ...
                                            <span>
                                            <h3><?php echo Yii::t('app','Week Days'); ?></h3></span>
                                            <?php
