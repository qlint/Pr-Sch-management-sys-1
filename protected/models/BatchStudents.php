...
class BatchStudents extends CActiveRecord
{
	...
	public function search()
	{
		...
		public function StudentBatch($student_id)
        {
			...
			$criteria->condition	= 't.is_active=:is_active AND t.is_deleted=:is_deleted AND t1.student_id=:student_id AND t1.result_status=:result_status AND t1.status!=:status';
			$criteria->params		= array(':is_active'=>1, ':is_deleted'=>0, ':student_id'=>$student_id, ':result_status'=>0, ':status'=>2);
