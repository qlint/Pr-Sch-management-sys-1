...
define('BASEURL', 'http://school.lets.com.pk');

//Database connections
define('DB_CONNECTION','mysql:host=localhost:3307;port=3307;dbname=openschool_demo');
define('DB_USER','NasfiaAdmin');
define('DB_PWD','Nasfia#607.');
